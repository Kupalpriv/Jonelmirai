...
module.exports = {
    ...
    onLaunch: async function ({ api, event, target }) {
        ...
        const commandName = argument;
        const commandFile = commandFiles.find(file => file.toLowerCase() === `${commandName}.js`);
        if (commandFile) {
